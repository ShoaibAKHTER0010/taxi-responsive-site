...
const Happy = () => {
  return (
    ...
    <main className="mx-auto  w-full bg-[#F7F2FF]">
    ...
    <p className=" lg: text-[34px] xl:text-[46px] pt-4">
            ...
            {/* card */}
          <div className='bg-white px-4  my-14 rounded-xl'>
          <p className='text-violet-500  font-bold font-Plus Jakarta Sans leading-[42.28px] md:leading-[67.28px] '>“</p>
          <p className="  text-zinc-800 text-[17.17px] font-normal font-['Plus Jakarta Sans'] leading-[29.18px] tracking-tight">
